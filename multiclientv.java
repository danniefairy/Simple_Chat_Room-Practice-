...
public class multiclientv{
  
    public static void main(String[] args)throws Exception{
	//Process p=Runtime.getRuntime().exec("C:\\Program Files\\Internet Explorer\\iexplore.exe www.google.com.tw");
        //使用本地文件系統接受網絡數據並存為新文件
     String filename="C:/Users/Dannie/Desktop/clientimg/newfile1.mp4";
        int port=8888;
     ...
     System.out.println("接收檔案的新檔名為:"+filename);
		...
		Process process=Runtime.getRuntime().exec("C:\\Program Files\\Windows Media Player\\wmplayer.exe C:\\Users\\Dannie\\Desktop\\clientimg\\newfile1.mp4");
		//Test s = new Test();
		//s.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		//Process process=Runtime.getRuntime().exec("cmd  start dir"+"C:/Users/Dannie/Desktop/clientimg/newfile1.mp4");
		//Process process=Runtime.getRuntime().exec("c: cd Users cd Dannie cd Desktop cd clientimg cd newfile1.mp4");	
